...
const Header = () => {
    ...
    const menuItems = <>
        <li className="font-semibold ml-2"><Link to='/'>Home</Link></li>
        ...
        <div className='max-w-screen-xl mx-auto'>
            <div className="navbar p-4 h-24 mb-8 bg-base-100">
                <div className="flex-1">
                    ...
                    <Link className="">
                        <img className="w-32 h-20 rounded-3xl" src={logo} alt="" />
                    </Link>
                                ...
                                <label tabIndex={0} className="btn btn-ghost btn-circle avatar tooltip tooltip-bottom" data-tip={user?.displayName}>
                                    {
                                        user?.uid ?
                                            <>
                                                ...
                                                <i className="fa-solid w-8 h-4 font-bold fa-angle-down"></i>
                                            </>
                                            :
