...
const ServicesDemo = () => {
    ...
    useEffect(() => {
        fetch('https://it-solution-server.vercel.app/services')
    ...
    return (
        <div id='services'>
            <div className='flex flex-col items-center'>
                ...
                <p className='w-3/5 text-center text-gray-600'>The kind of services, IT Services are providing right now with integrity and in appropriate way. IT Services provides the best.</p>
            </div>
